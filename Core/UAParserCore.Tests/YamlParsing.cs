...
//            string yamlContent = this.GetTestResources("UAParserCore.Tests.Regexes.regexes.yaml");
...
//            MinimalYamlParser minimal = new UAParserCore.MinimalYamlParser(yamlContent);
